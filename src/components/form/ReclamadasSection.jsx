  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2"><CnpjSugestao prefixo={prefixo} nome={data[`${prefixo}_NOME`]} logradouro={data[`${prefixo}_LOGRADOURO`]} cep={data[`${prefixo}_CEP`]} compl={data[`${prefixo}_ENDCOMPL`]} /></div>
