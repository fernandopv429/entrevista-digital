...
const FIELDS = ["DATA_ADMISSAO","DATA_RESCISAO","SALARIO"];

export default function PeriodoSection({ data, onChange }) {
  return <SectionCard number="3" title="Tempo laborado e remuneração" incomplete={hasEmpty(data, FIELDS)}><div className="space-y-4">
