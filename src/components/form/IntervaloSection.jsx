...
export default function IntervaloSection({ data, onChange, onChoice }) {
  ...
  return <SectionCard number="9" title="Intervalo intrajornada"><div className="space-y-6">
    ...
    {suprimido && <>
      <Field label="Quanto tempo era gozado, em média" name="INTERVALO_GOZADO" value={data.INTERVALO_GOZADO} onChange={onChange} placeholder="Ex.: 10 a 15 minutos" required />
