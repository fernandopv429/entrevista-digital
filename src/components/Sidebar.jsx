    ...
    <header className="sticky top-0 z-20 px-3 pt-3">
      <nav className="flex items-center gap-4 rounded-2xl bg-ink px-4 py-4 text-white sm:px-6">
        <div className="flex items-center">
          <Image src="https://media.base44.com/images/public/6a734d6c72c1f853994b8733/0dbb0b8f0_image.png" alt="Fernando Vieira Advogados" className="h-12 w-56" fittingType="fit" />
        </div>
